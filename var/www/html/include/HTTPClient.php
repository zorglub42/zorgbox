...
class HttpClient{
         ...
         * @return HttpResponse 
         */
        private function doRequest($method, $url, $headers=NULL, $content="", $baUsername="", $baPassword="")
        {
                ...
                if ($baUsername != ""){
                        array_push($headers, "Authorization: Basic " . base64_encode($baUsername . ":" . $baPassword)) ;
                }
        ...
        /**
         * Executes a PUT HTTP request on remote server.
         * 
         ...
         */
        function Put($url, $content="", $headers=NULL, $baUsername="", $baPassword="")
        {
                return $this->doRequest("PUT",  $url, $headers, $content, $baUsername, $baPassword);
        }        
        /**
         ...
         * @return HttpResponse object
         */
        function Get($url, $headers=NULL, $baUsername="", $baPassword="")
        {
         ...
         * @return HttpResponse object
         */
        function Post($url, $content="", $headers=NULL, $baUsername="", $baPassword="")
        {
